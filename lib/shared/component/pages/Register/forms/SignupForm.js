...
function (_React$Component) {
  ...
  function SignupForm() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onSubmit", function (e) {
      ...
      if (Object.keys(errors).length === 0) {
        if (_this.state.data.email != "pensheelapp@gmail.com") {
          ...
          _this.props.submit(_this.state.data).then(function () {
  ...
  _createClass(SignupForm, [{
    ...
    value: function render() {
      ...
      }), errors.message && _react.default.createElement(_InlineError.default, {
        text: errors.message
...
(function () {
  ...
  reactHotLoader.register(SignupForm, "SignupForm", "/home/suraj/Desktop/JohnyBravo/astav/Production/recheck/MUCH-STORY/src/shared/component/pages/Register/forms/SignupForm.js");
  reactHotLoader.register(_default, "default", "/home/suraj/Desktop/JohnyBravo/astav/Production/recheck/MUCH-STORY/src/shared/component/pages/Register/forms/SignupForm.js");
})();
